    ...
    public class Helpers
    {
        ...
        public static List<LevelData> GetLevelData()
        {
            List<LevelData> levels = new List<LevelData>()
            {
                ...
                new LevelData("Midday Gardens", 10, 5, true, false, 400, [], [], [Addresses.MiddayFireballZoeAddress], Addresses.GetVersionAddress(Addresses.MiddayGemMask), 123, [72, 89, 90, 109, 126]),
                ...
                new LevelData("Evening Lake", 19, 5, true, false, 400, [], [Addresses.EveningLifeBottleAddress], [Addresses.EveningInvincibilityZoeAddress], Addresses.GetVersionAddress(Addresses.EveningGemMask), 75, [31, 37, 60, 61, 66]),
