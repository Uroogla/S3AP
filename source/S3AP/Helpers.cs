    ...
    public class Helpers
    {
        ...
        public static List<LevelData> GetLevelData()
        {
            List<LevelData> levels = new List<LevelData>()
            {
                ...
                new LevelData("Fireworks Factory", 22, 6, false, false, 600, ["Find Agent 9's powerup"], [Addresses.FireworksAgentLifeBottleAddress, Addresses.FireworksOOBLifeBottleAddress], [], Addresses.GetVersionAddress(Addresses.FireworksGemMask), 233, [14, 20, 42, 47, 77, 82, 97, 98, 104, 105, 106, 108, 141, 153, 155, 177]),
