...
location_tables = {
#Homeworld 1
# Gemsanity checks are in the order they are stored in RAM, but there may be unused bits in between.
# Client should not just iterate over memory, or IDs will not line up.
"Sunrise Spring": [
    ...
    Spyro3LocationData(f"Sunrise Spring: Green gem left of starting pond", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Blue gem left and front of start", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem left of starting pond", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Leftmost green gem on first step in front of start", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Basket behind Isabelle", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket right and back of start", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem left of start", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Blue gem right of start", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem left of start", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Basket in front of Isabelle", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Leftmost red gem on first step in front of start", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem behind Sunny Villa", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Basket on ledge by Cloud Spires", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem on ledge by Cloud Spires", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem on ledge by Cloud Spires", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second vase under steps by Hunter", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem right of Sunny Villa", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Rightmost red gem on first step in front of start", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem by Isabelle", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket on right side second step", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket on right side second step", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Basket left of Zoe by start", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket right and back of start", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First vase by Zoe near Molten Crater", f"Sunrise Spring Gold Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem on right side of grass by balloon", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem behind Sunny Villa to the right", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second vase by Zoe near Molten Crater", f"Sunrise Spring Gold Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem across from cave entrance", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second vase behind Molten Crater", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First vase behind Molten Crater", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket behind Molten Crater", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Basket right of Mushroom Speedway", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Blue gem on right side of first step of path to Molten Crater", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket on fifth step to Mushroom Speedway", f"Sunrise Spring Gold Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Third red gem behind Molten Crater", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem by Hunter near Seashell Shores", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem left and back of start", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem left and back of start", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: green gem by tree in front of Sheila's Alp", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Blue gem right of cave entrance", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Blue gem on right side of first step of path to Molten Crater", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Blue gem on second step of path to Molten Crater", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem at end of cave", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem on cave right side", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First vase under steps by Hunter", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket around balloon", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket in front of start", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket in front of start", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Basket left of starting pond", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket around balloon", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second vase around balloon", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Third vase around balloon", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem around balloon", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second red gem around balloon", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First red gem around balloon", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket past starting pond", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem under Cloud Spires", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem on first step right of stream by start", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem by tree in front of Sheila's Alp", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket past starting pond", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem past starting pond", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem past starting pond", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First red gem right of Sunny Villa", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second red gem right of Sunny Villa", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First vase around balloon", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Gold gem on third step to Hunter", f"Sunrise Spring Gold Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Gold gem on cave right side", f"Sunrise Spring Gold Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket on left side of first step of path to Molten Crater", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket on left side of first step of path to Molten Crater", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem on right side of path to Molten Crater", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem on first step to Hunter", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem under ledge by Cloud Spires", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem under ledge by Cloud Spires", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem under Cloud Spires", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem on second step to Hunter", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Basket on steps by Hunter", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem by Zoe near Molten Crater", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem on first step to Mushroom Speedway", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem on fourth step to Mushroom Speedway", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem on right side of grass by balloon", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem in front of balloon", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem in front of balloon", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem in front of Mushroom Speedway", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Blue gem right of Molten Crater", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem right of Molten Crater", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First red gem behind Molten Crater", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second red gem behind Molten Crater", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Blue gem left of Molten Crater", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First underwater vase by path to Mushroom Speedway", f"Sunrise Spring Gold Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First underwater vase by balloon", f"Sunrise Spring Gold Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second underwater vase by balloon", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Underwater vase behind Seashell Shores", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket behind Molten Crater", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem on left side of path to Molten Crater", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem on second step of path to Molten Crater", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Basket left of Molten Crater", f"Sunrise Spring Gold Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second green gem behind Molten Crater", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem left of Molten Crater", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Underwater red gem behind Seashell Shores", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second underwater green gem by Hunter", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Underwater blue gem by path to Mushroom Speedway", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Underwater blue gem by Bruce", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket on first step to Mushroom Speedway", f"Sunrise Spring Gold Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket on first step to Mushroom Speedway", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First underwater green gem by Hunter", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Underwater red gem by path to Mushroom Speedway", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Underwater red gem by balloon", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Underwater red gem by Bruce", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem near balloon", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem behind Seashell Shores", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket under cave entrance", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket by tree in front of Sheila's Alp", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket by tree in front of Sheila's Alp", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem next to Cloud Spires", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket on cave right side", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First green gem behind Molten Crater", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Leftmost red gem on second step in front of start", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket behind Sunny Villa", f"Sunrise Spring Gold Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket behind Sunny Villa", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second red gem on cave left side", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket on cave right side", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Basket at end of cave", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem left of Sheila's Alp", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem left of Sheila's Alp", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket under cave entrance", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First green gem at end of cave", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First red gem on cave left side", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Basket on cave left side", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First green gem on cave right side", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Green gem on cave left side", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second green gem at end of cave", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second underwater vase by path to Mushroom Speedway", f"Sunrise Spring Green Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket on left side of grass by balloon", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket on left side of grass by balloon", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem on left side of grass by balloon", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket in cave entrance", f"Sunrise Spring Gold Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First basket in cave entrance", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second basket on fifth step to Mushroom Speedway", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem by tree across from Mushroom Speedway", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: First vase left of Mushroom Speedway", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Red gem on second step to Mushroom Speedway", f"Sunrise Spring Red Gem", Spyro3LocationCategory.GEMSANITY),
    Spyro3LocationData(f"Sunrise Spring: Second vase left of Mushroom Speedway", f"Sunrise Spring Blue Gem", Spyro3LocationCategory.GEMSANITY),
],
"Sunny Villa": [
