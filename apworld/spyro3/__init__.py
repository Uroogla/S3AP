...
class Spyro3World(World):
    ...
    def generate_early(self):
        ...
        if self.options.enable_gemsanity_checks.value:
            self.enabled_location_categories.add(Spyro3LocationCategory.GEMSANITY)
        print(self.enabled_location_categories)
    ...
    def create_regions(self):
        ...
        create_connection("Sunrise Spring", "Midday Garden")
    ...
    def create_item(self, name: str) -> Item:
        ...
        if name in key_item_names or \
                item_dictionary[name].category == Spyro3ItemCategory.EGG or \
                item_dictionary[name].category == Spyro3ItemCategory.EVENT or \
                item_dictionary[name].category == Spyro3ItemCategory.GEM:  # In glitched settings this could be useful.
    ...
    def set_rules(self) -> None:          
        ...
        if Spyro3LocationCategory.GEM in self.enabled_location_categories:
            ...
            if Spyro3LocationCategory.GEMSANITY in self.enabled_location_categories:
                # TODO: This is locked by access to all gems.  SBR is also locked by all gems.
                #set_rule(self.multiworld.get_location("Sunrise Spring: All Gems", self.player), lambda state: )
